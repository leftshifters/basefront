        ...
        App = {
            ...
            zen: function ($elements) {
                ...
                App.env.addObject('a', {
                    ...
                    html: '<div class="btn-group"><button type="submit" class="btn btn-default btn-primary js-save-doc">Save</button><button type="submit" class="btn btn-default btn-danger js-cancel-doc">Cancel</button></div>'
